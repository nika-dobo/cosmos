// Space history timeline and animations
class SpaceHistoryTimeline {
    ...
    playTimelineSound() {
        // Play a subtle sound effect when timeline item appears
        if (!window.audioMuted) {
            const audio = new Audio('data:audio/wav;base64,');
            audio.volume = 0.1;
            audio.play().catch(() => {});
        }
    }
