...
function compareSizes(planet1, planet2) {
    ...
    if (size1 > size2) {
        return `${planet1} is ${(size1 / size2).toFixed(2)} times larger than ${planet2}`;
    } else {
        return `${planet2} is ${(size2 / size1).toFixed(2)} times larger than ${planet1}`;
    }
}
